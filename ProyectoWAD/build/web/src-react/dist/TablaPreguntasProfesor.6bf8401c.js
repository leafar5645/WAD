...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"TablaPreguntas.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.TablaPreguntas = void 0;
...
function (_React$Component) {
  _inherits(TablaPreguntas, _React$Component);

  function TablaPreguntas(props) {
    var _this;

    _classCallCheck(this, TablaPreguntas);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(TablaPreguntas).call(this, props));
    _this.state = {
      Nombres: _this.obtenerNombres(),
      ID: _this.obtenerID()
    };
    _this.Ver = _this.Ver.bind(_assertThisInitialized(_this));
    _this.Modificar = _this.Modificar.bind(_assertThisInitialized(_this));
    _this.Eliminar = _this.Eliminar.bind(_assertThisInitialized(_this));
    return _this;
  } //funcion de AJAX que genere el arreglo con los nombres


  _createClass(TablaPreguntas, [{
    key: "obtenerNombres",
    value: function obtenerNombres() {
    ...
    key: "generarTabla",
    value: function generarTabla() {
      var tabla = [];
      tabla.push(_react.default.createElement("th", null, "Nombre de Pregunta"));
      tabla.push(_react.default.createElement("th", null, "Id Pregunta"));

      for (var i = 0; i < this.state.Nombres.length; i++) {
        var fila = _react.default.createElement("tr", {
          key: this.state.ID[i]
        }, _react.default.createElement("td", {
          key: "0"
        }, this.state.Nombres[i]), _react.default.createElement("td", {
          key: "1"
        }, this.state.ID[i]), _react.default.createElement("td", {
          key: "2"
        }, _react.default.createElement("button", {
          onClick: this.Eliminar.bind(this, this.state.ID[i])
        }, "Eliminar Pregunta")), _react.default.createElement("td", {
          key: "3"
        }, _react.default.createElement("button", {
          onClick: this.Modificar.bind(this, this.state.ID[i])
        }, "Midificar Pregunta")), _react.default.createElement("td", {
          key: "4"
        }, _react.default.createElement("button", {
          onClick: this.Ver.bind(this, this.state.ID[i])
        }, "Ver Pregunta")));
    ...
    key: "Ver",
    value: function Ver(id) {
      alert("VER: " + id);
    }
  }, {
    key: "Modificar",
    value: function Modificar(id) {
      alert("Modificar: " + id);
    }
  }, {
    key: "Eliminar",
...
exports.TablaPreguntas = TablaPreguntas;
},{"react":"../node_modules/react/index.js"}],"TablaPreguntasProfesor.js":[function(require,module,exports) {
"use strict";
...
var _TablaPreguntas = require("./TablaPreguntas.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom.default.render(_react.default.createElement(_TablaPreguntas.TablaPreguntas, null), document.getElementById('root'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./TablaPreguntas.js":"TablaPreguntas.js"}],"C:/Users/Marcus/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "55526" + '/');
...
},{}]},{},["C:/Users/Marcus/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","TablaPreguntasProfesor.js"], null)
